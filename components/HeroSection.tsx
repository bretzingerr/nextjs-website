    ...
    <section id="home">
      <div className="flex flex-col text-center items-center justify-center animate-fadeIn animation-delay-2 my-10 sm:my-32 sm:mx-12 md:my-48 md:flex-row md:space-x-4 md:text-left">
        ...
        <div className="md:mt-2 md:w-3/5">
          <h1 className="text-2xl font-volkhov mt-6 md:mt-0 md:text-4xl text-stone-200">Hi, I&#39;m Becca!</h1>
      ...
      <div className="flex flex-row items-center text-center justify-center ">
        <Link
          ...
          duration={500}
        >
          <HiArrowDown size={35} className="animate-bounce text-neutral-100" />
        </Link>
      </div>
    </section>
  )
